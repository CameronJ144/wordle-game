import './nav.css';
export default function Nav({ setPaused, setShowHtp, setShowHint }) {
  return (
    <nav>
      <button className="nav-btn" onClick={() => setShowHint && setShowHint(true)}>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-lightbulb-fill" viewBox="0 0 16 16">
      ...
      <button className="nav-btn" onClick={() => setShowHtp && setShowHtp(true)}>
